        ...
        <div className="space-y-8">
          <div>
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              As a Software Engineering undergraduate, I am passionate about developing innovative solutions
              that make a real impact. With a strong foundation in full-stack development and blockchain
              technology, I consistently lead projects that challenge conventional approaches and deliver
              practical results.
            </p>
          </div>
